...
Next I'll explore the approach to the prompt optimization in NL2SQL agent described in the paper ["Effectiveness of Prompt Optimization in NL2SQL Systems"](https://arxiv.org/pdf/2505.20591) that shows the improvement coming from an *Iterative Prompt Optimization* reported in this article's pitcure:

<img src="https://raw.githubusercontent.com/corradodebari/wayflow_samples/main/images/IPO.png" width="400" />

With a framework like DataFlow, it should be possible to automatically generate the exemplars needed for an NL2SQL system using retrieval-based exemplar selection, and use them to guide the model — ultimately improving translation accuracy.
